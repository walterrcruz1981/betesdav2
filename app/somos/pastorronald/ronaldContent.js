...
export const biography = {
    title: 'Ronald Vides',
    description: <div className={styles.description}>El siervo de Dios que hasta la fecha está pastoreando Ministerios Betesda, nació en la ciudad de Santa Ana, en la Republica de El Salvador, Centro América el 3 de febrero del año 1969. Es el segundo hijo de Ricardo Alberto Vides y de Telma Barrera. Vivió en El Salvador 21 años, en donde estudio hasta los estudios Universitarios.

        En busca de nuevas aventuras y oportunidades, decidió emigrar a los Estados Unidos de América. Fue así que, después de estar caminando por dieciocho días en el territorio mexicano, el 18 de diciembre de 1989 entro a los Estados Unidos por la ciudad de Tijuana Fronteriza a Estados Unidos. Llego al Sur Centro de Los Ángeles en donde vivió por un año en dicha ciudad. Después se movió al condado de Orange. Esta decisión lo llevo a vivir por varios meses en la calle en estacionamientos públicos o donde lo agarrara la noche. Viviendo en este Condado, el joven Ronald por engaños, asistió a una reunión cristiana en el ministerio en español de la iglesia Saddleback del pastor Rick Warren, donde el pastor en español era el Dr. Yamile Fernández. Continúo asistiendo a dicho Centro y en el mes de marzo del año 1991, aceptó al Señor Jesucristo como su Señor y Salvador. En el mes de mayo de ese mismo año fue bautizado.
        <br></br><br></br>
        <div className={styles.innerImage}><Image width={300} height={400} src={image2} alt='familia pic'></Image></div>
        ...
        <div className={styles.innerImage2}><Image width={350} src={image3} alt='familia pic'></Image></div>
